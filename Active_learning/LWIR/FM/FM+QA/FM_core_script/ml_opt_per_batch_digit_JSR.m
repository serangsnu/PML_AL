function output=ml_opt_per_batch_digit_JSR(input,ttn)
...
% Import Dataset
filename=sprintf('%s_%s_bat%d',filename_header,optimizer,ttn);
...
%tic
    ...
    save('cal_TMM_total_time.mat', 'caltime_TMM_total');
    %save('cal_fm_brute_iter_time.mat', 'caltime2');
    %save('cal_iter_f+b_time.mat', 'cal_file_iter_array');
