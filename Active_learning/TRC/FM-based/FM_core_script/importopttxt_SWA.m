...
%   OPTARCL4TRAINT125 = IMPORTFILE(FILENAME) 디폴트 선택 항목의 텍스트 파일 FILENAME에서
%   데이터를 읽습니다.
%
%   OPTARCL4TRAINT125 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 텍스트 파일
...
% MATLAB에서 다음 날짜에 자동 생성됨: 2022/02/04 11:25:06
